...
void main() {
  ...
  // Ambient
  vec3 ambient1 = light1.ambient * texture(material.diffuse, tex_coord).rgb;
  vec3 ambient2 = light2.ambient * texture(material.diffuse, tex_coord).rgb;
  ...
  vec3 diffuse1 = light1.diffuse * diff1 * texture(material.diffuse, tex_coord).rgb;
  vec3 diffuse2 = light2.diffuse * diff2 * texture(material.diffuse, tex_coord).rgb;
  ...
  vec3 specular1 = light1.specular * spec1 * texture(material.specular, tex_coord).rgb;
  vec3 specular2 = light2.specular * spec2 * texture(material.specular, tex_coord).rgb;
